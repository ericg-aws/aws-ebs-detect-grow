...
# requirements: export AWS_REGION='us-east-1' && export FUNCTION_NAME='auto01-stepfunc-trigger' && export AWS_PROFILE='grmeri-training-admin'
# container: docker run -it --rm -v ${HOME}/repos/ebs-ec2-fs-grow/auto01-stepfunc-trigger/lambda:/ericg -v ${HOME}/.aws/credentials:/root/.aws/credentials:ro -e AWS_DEFAULT_PROFILE='grmeri-training-admin' -e AWS_REGION='us-east-1' -e FUNCTION_NAME='auto01-stepfunc-trigger' ericstephengarcia/codebuild-al2-3:latest bash
